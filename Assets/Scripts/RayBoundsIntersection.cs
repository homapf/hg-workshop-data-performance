...
public class RayBoundsIntersection : BaseJobObjectExample
{
    ...
    NativeArray<byte> m_RayIntersectionResults;
    ...
    protected virtual void Start()
    {
        ...
        m_RayIntersectionResults = new NativeArray<byte>(m_ObjectCount, Allocator.Persistent);
    ...
    struct RayIntersectionListJob : IJob
    {
        ...
        [ReadOnly]
        public NativeArray<byte> boundsIntersected;
